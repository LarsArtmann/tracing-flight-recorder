...
sound; the _presentation and trust infrastructure_ around it is not. This plan
...
**Why 51%:** right now the repo _looks unfinished/leaky_. A reviewer's first
...
**Why last:** these are where the crate _goes after_ it exists and is published.
...
_after approval_. Should I start executing P0 the moment you answer 1–3, or
